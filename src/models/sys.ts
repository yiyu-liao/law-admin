...
export default {
  ...
  effects: (dispatch: Dispatch) => ({
    ...
    async getMenusById(params: number[] | number = []) {
      try {
        const res: Res = await axios.post(`/admin/getMenusById`, params);
        return res;
      } catch (err) {
        message.error("网络错误，请重试");
      }
    ...
    async getPowerById(params: { id: number | number[] }) {
      try {
        const res: Res = await axios.post(`/admin/getPowerById`, params);
        return res;
      } catch (err) {
        message.error("网络错误，请重试");
      }
    ...
    async getRoleById(params: { id: number | number[] }) {
      try {
        const res: Res = await axios.post(`/admin/getRoleById`, params);
        return res;
      } catch (err) {
        message.error("网络错误，请重试");
      }
    ...
    async delRole(params: { id: number }) {
      try {
        const res: Res = await axios.post("/admin/deleteUser", params);
        return res;
      } catch (err) {
        message.error("网络错误，请重试");
      }
    ...
    async getUserList(params: {
      ...
      try {
        const res: Res = await axios.post(`/admin/userList`);
        return res;
      } catch (err) {
        message.error("网络错误，请重试");
      }
    ...
    async addUser(params: UserBasicInfoParam) {
      try {
        const res: Res = await axios.post("/admin/addUser", params);
        return res;
      } catch (err) {
        message.error("网络错误，请重试");
      }
    ...
    async upUser(params: UserBasicInfoParam) {
      try {
        const res: Res = await axios.post("/admin/updateBaseInfo", params);
        return res;
      } catch (err) {
        message.error("网络错误，请重试");
      }
    ...
    async getVerfifyUserList() {
      try {
        const res: Res = await axios.post("/admin/clientVerifyUserList");
        return res;
      } catch (err) {
        message.error("网络错误，请重试");
      }
    ...
    async getAppealList() {
      try {
        const res: Res = await axios.post("/admin/appealList");
        return res;
      } catch (err) {
        message.error("网络错误，请重试");
        return;
    ...
    async uploadFile(params: { files: unknown[] }) {
      try {
        const res: Res = await axios.post("/files/upload", params);
        return res;
      } catch (err) {
        message.error("网络错误，请重试");
      }
    ...
    async onAgressAppeal(params: unknown) {
      try {
        const res: Res = await axios.post("/admin/agreeAppeal", params);
        return res;
      } catch (err) {
        message.error("网络错误，请重试");
      }
    ...
    async onRejectAppeal(params: unknown) {
      try {
        const res: Res = await axios.post("/admin/rejectAppeal", params);
        return res;
      } catch (err) {
        message.error("网络错误，请重试");
      }
